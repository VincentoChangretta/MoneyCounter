  ...
  return (
    <section className={classNames(cls.MainPageTop, {}, [className],)}>
      <div className={cls.titleBox}>
        ...
        <div>
          <p>Удобный и эффективный инструмент для учета доходов и расходов. Достигайте финансовой стабильности с полным контролем над бюджетом с помощью нас</p>
        </div>
      </div>
      <Link to={routePath.creator}>
        <Button theme={ButtonTheme.FULL_RADIUS} className={MARGIN_X_AUTO}>Начать</Button>
      </Link>
    </section>
  );
}
