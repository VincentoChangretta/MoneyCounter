...
describe('classNames', () => {
  ...
  test("with All", () => {
    expect(classNames("class", {myBool: true}, ["aram", "arman"])).toBe("class aram arman myBool")
  })
  test("with All", () => {
    expect(classNames("class", {myBool: true}, ["aram", "undefined"])).toBe("class aram undefined myBool")
  })
  test("with All", () => {
